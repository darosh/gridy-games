      ...
      <div class="mt-1" style="text-align: center">
        <v-layout row mb-2 px-2 style="height: 48px">
          <v-flex xs6 class="pr-2">
            <g-player v-if="game" :value="1" :game="game" :waiting="waiting" />
          </v-flex>
          ...
          <v-flex xs6 class="pl-2">
            <g-player v-if="game" :value="2" :game="game" :waiting="waiting" :switcher="canSwitch" :class="{clickable: canSwitch}" @click.native="canSwitch && switchPlayer()" />
          </v-flex>
        </v-layout>
        <g-board :game="game" :frame="frame" :margin="margin" :move="move" :vertical="vertical" :waiting="waiting" interactive/>
      </div>
    </v-layout>
